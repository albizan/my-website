...
import { textColorDarker, textColorLighter, accentColor } from '../../../themes/base'
import { cardBackground, pillTextColor } from '../../../themes/projects'

const Project = ({ img, title, description, categories, technologies, link, github }) => {
	const CardProject = styled.div`background-color: ${cardBackground};`
	...
	`
	const CardTitle = styled.h4`color: ${textColorDarker};`

	const CardDescription = styled.p`color: ${textColorLighter};`
	...
	`
	const Tech = styled.span`color: ${accentColor};`
	...
	return (
		<div id="project-wrapper" className="w-full lg:w-1/2 xl:w-1/3 px-4 mb-8">
			<CardProject className="rounded-lg overflow-hidden shadow-lg">
				<CardImageWrapper>
					<img src={img} loading="lazy" alt="test" className="mx-auto w-full object-cover" />
				</CardImageWrapper>
